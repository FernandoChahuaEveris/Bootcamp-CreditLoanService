...
public class MapperPersonalCredit {
  public static PersonalCreditDTO entityToDTO(PersonalCredit personalCredit) {
    return PersonalCreditDTO.builder().amountPaid(personalCredit.getAmountPaid())
        .creditBalance(personalCredit.getCreditBalance()).creditName(personalCredit.getCreditName())
        ...
        .currencyType(personalCredit.getCurrencyType()).build();
  }

  public static PersonalCredit dtoToEntity(PersonalCreditDTO personalCreditDTO) {
    return PersonalCredit.builder().idPersonalCredit(personalCreditDTO.getIdPersonalCredit())
        .amountPaid(personalCreditDTO.getAmountPaid())
        .creditBalance(personalCreditDTO.getCreditBalance())
        .creditName(personalCreditDTO.getCreditName()).creditType(personalCreditDTO.getCreditType())
        .currencyType(personalCreditDTO.getCurrencyType())
        .personalClient(new PersonalClient(personalCreditDTO
            .getIdPersonalClient(), personalCreditDTO.getDni()))
        .build();
  }
