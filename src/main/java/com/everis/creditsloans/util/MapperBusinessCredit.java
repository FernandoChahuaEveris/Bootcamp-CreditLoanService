...
public class MapperBusinessCredit {
    public static BusinessCreditDTO entityToDTO(BusinessCredit businessCredit){
        return BusinessCreditDTO.builder()
                .amountPaid(businessCredit.getAmountPaid())
                .creditBalance(businessCredit.getCreditBalance())
                .creditName(businessCredit.getCreditName())
                .creditType(businessCredit.getCreditType())
                .idBusinessCredit(businessCredit.getIdBusinessCredit())
                .ruc(businessCredit.getBusinessClient().getRuc())
                .idBusinessClient(businessCredit.getBusinessClient().getIdBusinessClient())
                .build();
    }

    public static BusinessCredit dtoToEntity(BusinessCreditDTO personalCreditDTO){
        return BusinessCredit.builder()
                ...
                .businessClient(new BusinessClient(personalCreditDTO.getIdBusinessClient(),personalCreditDTO.getRuc()))
                .build();
    }
}
